...
import { Github, Linkedin, Mail, Code2, Briefcase, GraduationCap, Rocket, ExternalLink } from 'lucide-react';
...
export default function Portfolio() {
  ...
  const experiences = [
    ...
    },
    {
      ...
      period: '2025 - Present',
      description: 'Building tooling and simulation software for the aviation industry.'
    },
    {
      title: 'Lead Frontend Engineer',
      company: 'Ouroboros Jets',
      period: '2022 - 2025',
      description: 'Developed high-performance web applications for aviation clients, optimizing user experience and performance.'
    },
  ];
  ...
  const projects = [
    {
      ...
      description: 'Comprehensive suite for creating and distributing paid flight simulation content efficiently and securely.',
      tech: ['Rust', "C++", 'WASM', 'AWS', 'PostgreSQL', 'React'],
      link: 'https://www.infinity-simulations.com/#/about'
    },
    {
      title: 'Aero Dynamics T-38 Aircraft',
      description: 'High fidelity T-38 simulation model with realistic flight dynamics and systems.',
      tech: ['C++','Rust', 'PostgreSQL', 'WASM' ],
      link: 'https://www.infinity-simulations.com/#/aircraft'
    },
    {
      title: 'Ouroboros Jets E-Series Aircraft',
      description: 'Simulation of the Embraer E-Jet series with detailed systems and performance modeling.',
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 text-white">
      ...
      <section id="hero" className="min-h-screen flex items-center justify-center relative px-6">
        <div className="max-w-4xl text-center z-10">
          ...
          <h1 className="text-6xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-cyan-400 to-yellow-400 text-transparent bg-clip-text leading-loose">
           ...
           <h2 className="text-3xl font-bold mb-2 text-white"> Software Engineer & Full-Time Pilot</h2>
         
          <div className="flex gap-4 justify-center mb-12">
            <a href="https://github.com/tacotakedown" rel="noopener noreferrer" target="_blank" className="p-3 rounded-full bg-gray-800/50 backdrop-blur-sm hover:bg-cyan-500/20 transition-all duration-300 hover:scale-110">
              <Github size={24} />
            </a>
            <a href="mailto:portfolio.chief702@passmail.net" className="p-3 rounded-full bg-gray-800/50 backdrop-blur-sm hover:bg-cyan-500/20 transition-all duration-300 hover:scale-110">
              <Mail size={24} />
            </a>
          </div>
          <div className="flex gap-6 justify-center text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Airline Transport Pilot License, CFI/CFII/MEI, E170/E175 Type Ratings</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="py-20 px-6 relative">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="backdrop-blur-sm bg-gray-800/30 rounded-2xl p-8 border border-gray-700/50 hover:border-blue-500/50 transition-all duration-300">
              ...
              <p className="text-gray-300 leading-relaxed">
                Full-time pilot and flight instructor holding an Airline Transport Pilot License (ATPL), E170/E175 type ratings, and all instructor ratings (CFI, CFII, MEI). Holds a BS in Computer Science and is currently pursuing an MS in Computer Science while building advanced software for the aviation industry.
              </p>
            </div>
            <div className="backdrop-blur-sm bg-gray-800/30 rounded-2xl p-8 border border-gray-700/50 hover:border-yellow-400/50 transition-all duration-300">
              ...
              <p className="text-gray-300 leading-relaxed">
                Experienced software engineer with a passion for aviation technology. Skilled in low-level programming, simulation, and building tools that empower pilots and aviation professionals.
              </p>
            </div>
          </div>
          ...
          {/* Skills */}
          <div className="mt-16">
            <h3 className="text-3xl font-bold mb-8 text-center text-yellow-400">Technical Skills</h3>
            <div className="grid md:grid-cols-2 gap-6">
              {skills.map((skill) => (
                <div key={skill.name} className="backdrop-blur-sm bg-gray-800/20 rounded-xl p-6 border border-gray-700/30">
