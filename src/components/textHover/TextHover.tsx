		...
		>
			<defs>
				...
				>
					{hovered && (
						<>
							<stop offset="0%" stopColor={"var(--cursor-color)"} />
							<stop offset="25%" stopColor={"var(--cursor-color)"} />
							<stop offset="50%" stopColor={"var(--cursor-color)"} />
							<stop offset="75%" stopColor={"var(--cursor-color)"} />
							<stop offset="100%" stopColor={"var(--cursor-color)"} />
						</>
					)}
				</linearGradient>
